jQuery(document).ready(function ($) {
        ...
        fullpage = new Swiper(".fullpage-container", {
          ...
          on: {
            slideChangeTransitionStart: function () {
              setTimeout(function () {
                $(
                  ".fullpage-wrapper > .swiper-slide-active .aos-init"
    ...
    $("section").each(function () {
      ...
      $(this)
        ...
        .click(function () {
          ...
          if (!fullpage && $section.next().length)
            $("html, body").animate(
  ...
  }
  {
    ...
    $(".main-menu > .item.has-dropdown").each(function () {
      ...
      $container.children(".item-link").click(function () {
        ...
        if (isShow)
          $container.addClass("show").find(".sub-menu").stop().slideDown();
        return false;
      });
    });
    ...
    $separate.each(function (index, el) {
      ...
      function setPadding() {
        ...
        if (windowWidth >= breakpoints.xs)
          $sep.css("padding-top", data.xs ? data.xs : "");
        if (windowWidth >= breakpoints.sm)
          $sep.css("padding-top", data.sm ? data.sm : "");
        if (windowWidth >= breakpoints.md)
          $sep.css("padding-top", data.md ? data.md : "");
        if (windowWidth >= breakpoints.lg)
          $sep.css("padding-top", data.lg ? data.lg : "");
        if (windowWidth >= breakpoints.xl)
          $sep.css("padding-top", data.xl ? data.xl : "");
      }
      setPadding();
  ...
  }
  {
    ...
    $awards.each(function () {
      ...
      $("#awards-tab").on("shown.bs.tab", function () {
        ...
        if ($awardContent.find(".awards-thumb-container")[0].swiper)
          $awardContent.find(".awards-thumb-container")[0].swiper.update();
        if ($awardContent.find(".awards-container")[0].swiper)
          $awardContent.find(".awards-container")[0].swiper.update();
      });
    });
  }
  {
  ...
  $(".filter").each(function () {
    ...
    $(window).on("click", function (e) {
      var target = e.target;
      if (
        (!$(target).closest(".filter").length && $this.hasClass("active")) ||
        $(target).hasClass("btn-show-filter")
      ) {
        $this.removeClass("active");
      }
      return;
  ...
  // projects filter;
  {
    ...
    $projects_filter.each(function () {
      ...
      if ($(window).width() < 768)
        $grid.attr("data-grid-layout", $grid.data("grid-layout-mobile"));
      ...
      function render_project(data, start = 0, end = posts_per_page) {
        ...
        if (data.length) {
          ...
          $projects.html(
            '<h3 class="projects-not-found">Not Found Projects</h3>'
          );
          $projects_more.hide();
        }
      }
  ...
  });
  {
    ...
    $data_collapse.each(function (index, el) {
      ...
      if (
        $target.length &&
        $targetItem.length &&
        collapse < $targetItem.length
      ) {
        var $button = $("<a></a>");
        $button
          .addClass("btn-data-collapse")
          .text(collapsedTxt)
          .attr("href", "#showmore")
          .css("transition", ".4s all ease");
        ...
        function setHeight() {
          ...
          $this.find($this.data("target-item")).each(function (index, el) {
            if (index <= collapse - 1)
              heightCollapsed += $(this).outerHeight(true);
  ...
  });
  {
    ...
    $(".form-search").each(function (index, el) {
      ...
      $(window).click(function (e) {
        var target = e.target;
        if (
          (!$(target).closest(".form-search").length &&
            $this.hasClass("active")) ||
          $(target).hasClass("form-search")
        ) {
          $this.removeClass("active");
  ...
  }
  {
    $(".section-gallery-content .tabs-group .tab input").change(function () {
      var href = $(
        ".section-gallery-content .tabs-group .tab input:checked"
      ).val();
    ...
    $(".scroll-to-section").click(function () {
      ...
      $("html, body")
        ...
        .animate(
          {
            scrollTop:
              $($(this).attr("href")).offset().top - $(".nav-header").height(),
          },
          500
        );
    });
...

  {
    $(".career-filter .dropdown-item").click(function () {
      ...
      if ($(".career-filter .dropdown-toggle").length)
        $(".career-filter .dropdown-toggle").text(activeText);
    });
  }
  {
  ...
  }
  {
    function autoScroll() {
      if ($(window).scrollTop() > 100) {
        if (!$(".nice-feature .mouse-scroll").hasClass("hide"))
          $(".nice-feature .mouse-scroll").addClass("hide");
      } else {
        if ($(".nice-feature .mouse-scroll").hasClass("hide"))
          $(".nice-feature .mouse-scroll").removeClass("hide");
      }
    }
    autoScroll();
