<?php
/*
Template Name: Apartment Collection (English)
*/
...
<section class="products-hero">
    <div class="container">
        <div class="text-center">
            <h1>Apartment Collection</h1>
            <p>Discover luxury yacht apartments with modern design and world-class amenities</p>
        </div>
    </div>
</section>
...
<section class="products-section">
    <div class="container">
        <div class="text-center">
            <h2 style="font-size: 2.5rem; font-weight: 700; color: #2C3E50; margin-bottom: 1rem;">Yacht Apartments</h2>
            <p style="font-size: 1.1rem; color: #7f8c8d; max-width: 600px; margin: 0 auto;">Refined design with modern living spaces and stunning ocean views</p>
        </div>
        
        <div class="products-grid">
            <!-- Product 1 -->
            <div class="product-card" onclick="openFullscreenModal(1)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_1PN1'); ?>" alt="1 Bedroom + 1" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                    <div class="product-overlay-text">View Details</div>
                </div>
                <div class="product-info">
                    <div class="product-type">Studio</div>
                    <h3 class="product-title">1 Bedroom + 1</h3>
                    <div class="product-area">Area: 44.16m²</div>
                </div>
            </div>

            <!-- Product 2 -->
            <div class="product-card" onclick="openFullscreenModal(2)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN1A'); ?>" alt="2 Bedroom + 1A" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    ...
                    <h3 class="product-title">2 Bedroom + 1A</h3>
                    <div class="product-area">Area: 67.85m²</div>
                </div>
            </div>

            <!-- Product 3 -->
            <div class="product-card" onclick="openFullscreenModal(3)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN2'); ?>" alt="2 Bedroom + 2" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">2 Bedroom</div>
                    <h3 class="product-title">2 Bedroom + 2</h3>
                    <div class="product-area">Area: 72.45m²</div>
                </div>
            </div>

            <!-- Product 4 -->
            <div class="product-card" onclick="openFullscreenModal(4)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN4'); ?>" alt="2 Bedroom + 4" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">2 Bedroom</div>
                    <h3 class="product-title">2 Bedroom + 4</h3>
                    <div class="product-area">Area: 78.92m²</div>
                </div>
            </div>

            <!-- Product 5 -->
            <div class="product-card" onclick="openFullscreenModal(5)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN4A'); ?>" alt="2 Bedroom + 4A" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">2 Bedroom</div>
                    <h3 class="product-title">2 Bedroom + 4A</h3>
                    <div class="product-area">Area: 82.18m²</div>
                </div>
            </div>

            <!-- Product 6 -->
            <div class="product-card" onclick="openFullscreenModal(6)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN1'); ?>" alt="3 Bedroom + 1" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    ...
                    <h3 class="product-title">3 Bedroom + 1</h3>
                    <div class="product-area">Area: 112.52m²</div>
                </div>
            </div>

            <!-- Product 7 -->
            <div class="product-card" onclick="openFullscreenModal(7)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN1A'); ?>" alt="3 Bedroom + 1A" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">3 Bedroom</div>
                    <h3 class="product-title">3 Bedroom + 1A</h3>
                    <div class="product-area">Area: 118.76m²</div>
                </div>
            </div>

            <!-- Product 8 -->
            <div class="product-card" onclick="openFullscreenModal(8)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN2'); ?>" alt="3 Bedroom + 2" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">3 Bedroom</div>
                    <h3 class="product-title">3 Bedroom + 2</h3>
                    <div class="product-area">Area: 125.68m²</div>
                </div>
            </div>

            <!-- Product 9 -->
            <div class="product-card" onclick="openFullscreenModal(9)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN3'); ?>" alt="3 Bedroom + 3" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">3 Bedroom</div>
                    <h3 class="product-title">3 Bedroom + 3</h3>
                    <div class="product-area">Area: 135.76m²</div>
                </div>
            </div>

            <!-- Product 10 -->
            <div class="product-card" onclick="openFullscreenModal(10)">
                <img src="<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN3A'); ?>" alt="3 Bedroom + 3A" class="product-image">
                <div class="product-overlay">
                    <div class="product-overlay-icon">
                        <i class="fas fa-eye"></i>
                    </div>
                ...
                <div class="product-info">
                    <div class="product-type">3 Bedroom</div>
                    <h3 class="product-title">3 Bedroom + 3A</h3>
                    <div class="product-area">Area: 142.84m²</div>
                </div>
            </div>
            ...
            <div class="product-card" onclick="openFullscreenModal(11)">
                ...
                <div class="product-info">
                    ...
                    <div class="product-area">Area: 38.24m²</div>
                </div>
            </div>
            ...
            <div class="product-card" onclick="openFullscreenModal(12)">
                ...
                <div class="product-info">
                    ...
                    <div class="product-area">Area: 42.18m²</div>
                </div>
            </div>
            ...
            <div class="product-card" onclick="openFullscreenModal(13)">
                ...
                <div class="product-info">
                    ...
                    <div class="product-area">Area: 285.75m²</div>
                </div>
            </div>
            ...
            <div class="product-card" onclick="openFullscreenModal(14)">
                ...
                <div class="product-info">
                    ...
                    <div class="product-area">Area: 342.18m²</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fullscreenModalLabel">Project Products</h5>
...
// Product images data
const productImages = [
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_1PN1'); ?>", alt: "1 Bedroom + 1" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN1A'); ?>", alt: "2 Bedroom + 1A" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN2'); ?>", alt: "2 Bedroom + 2" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN4'); ?>", alt: "2 Bedroom + 4" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_2PN4A'); ?>", alt: "2 Bedroom + 4A" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN1'); ?>", alt: "3 Bedroom + 1" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN1A'); ?>", alt: "3 Bedroom + 1A" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN2'); ?>", alt: "3 Bedroom + 2" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN3'); ?>", alt: "3 Bedroom + 3" },
    { src: "<?php echo get_attachment_url_by_slug('SUNSET-LAYOUT-CAN_3PN3A'); ?>", alt: "3 Bedroom + 3A" },
